...
GITHUB_BRANCH = "main"
GITHUB_USERNAME = "keanugithub"
GITHUB_PASSWORD = "Kyssa927!"
...
response = requests.get(GITHUB_REPO_URL + "?ref=" + GITHUB_BRANCH, auth=(GITHUB_USERNAME, GITHUB_PASSWORD))
...
response = requests.put(GITHUB_REPO_URL, auth=(GITHUB_USERNAME, GITHUB_PASSWORD), data=json.dumps(data))
